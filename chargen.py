...
class Chargen:
    ...
    async def solveExpression(self, tokens, x):
        ...
        # if the token is not an operator, move on, this is here for efficiency, the method will recur if a non-operator not on this list appears at the end anyway
